...
const experienceSection: ExperienceSection = {
  entries: [
    ...
    },
    {
      ...
      lines: [
        'Led the Mobile team where we developed many apps (see website for projects), with a structured development process using milestones and regular code reviews based on the Agile methodology.',
