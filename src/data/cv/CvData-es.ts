...
const experienceSection: ExperienceSection = {
  entries: [
    ...
    },
    {
      ...
      lines: [
        'Lideré el equipo de desarrollo móvil y web (proyectos visibles en mi web). Implementé un sistema basado en Agile con objetivos y revisiones de código para desarrollar proyectos de éxito con React, React Native y Firebase.',
